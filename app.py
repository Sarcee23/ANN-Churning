...
input_data = pd.DataFrame({
    ...
    'Gender': [gender],  # Directly store gender, we will encode it later
    'Age': [age],
    'Tenure': [tenure],
    'Balance': [balance],
...
# Combine one hot encoded 'Geography' column with the input data
...
st.write(f'Percentage chances of churning:{prediction_prob*100:.2f}')
